...
(function() {
    var Board = (function(){
        ...
        <!--Declaring and initializing various variables used in the game -->
        ...
        <!--Used to call the reset fuction-->
        function Board() {
            this.reset();
        }

        <!--Resetting the board using below algorithm-->
        Board.prototype.reset = function(){
            ...
            <!--Using 2 loops to push all the boxes to be empty-->
        ...
        <!--Checking Rows and returning NOUGHTS or CROSS if they equal to 3-->
        ...
        <!--Checking Colums and returning NOUGHTS or CROSS if they equal to 3-->
        ...
        <!--Checking Diagonals and returning NOUGHTS or CROSS if they equal to 3-->
        ...
        <!--Checking Other Diagonals and returning NOUGHTS or CROSS if they equal to 3-->
        ...
        <!--Marking the Row or Column or diagonal when they won the game-->
        ...
        <!--This below Function is used to check for winner at every turn-->
        ...
        <!--This fuction is used to switch players after every turn -->
